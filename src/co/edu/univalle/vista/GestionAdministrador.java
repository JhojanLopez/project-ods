 ...
 * @author JHOJANL
 */
public class GestionAdministrador extends javax.swing.JInternalFrame {

    public static String ventanaAdministradorActiva;// determinara si esta abierto este internal frame
    private Administrador adminLog;
    private DefaultTableModel modelo;
    
    
    public GestionAdministrador(Administrador adminLog) {

        ventanaAdministradorActiva= "activa";//declaramos que esta activa para despues validarla
        
        this.adminLog = adminLog;
        initComponents();
        CtrGestionAdministrador ctrl = new CtrGestionAdministrador(this, this.adminLog);
    ...
    private void initComponents() {
        ...
        jtablaGestionAdministrador.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Usuario", "Contrasena", "Codigo Avatar"
            }
        ) {
        ...
        if (jtablaGestionAdministrador.getColumnModel().getColumnCount() > 0) {
            jtablaGestionAdministrador.getColumnModel().getColumn(3).setHeaderValue("Contrasena");
            jtablaGestionAdministrador.getColumnModel().getColumn(4).setHeaderValue("Codigo Avatar");
        }
    ...
    private void formInternalFrameClosing(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosing
        ...
        ventanaAdministradorActiva = null;//si esta cerrada la pondra como nulo
    ...
    public JTable getJtablaGestionAdministrador() {
